...
namespace BookAdmin.org.SmarTech.controllers
{
    public class CntClsCustomer
    {
        ...
        public EntClsCustomer CheckCustomer(string identificationCard)
        {
            ...
            string storeProcedure = "existCustomer";
            using (DbConnection con = dpf.CreateConnection())
            {
                con.ConnectionString = constr;
                using (DbCommand cmd = dpf.CreateCommand())
                {
                    ...
                    using (DbDataReader dr = cmd.ExecuteReader())
                    {
                        if (dr.Read())
                        {
                            obj_customer = new EntClsCustomer((string)dr["identificationCard"], (string)dr["name"], (string)dr["lastname"], (string)dr["phone"], (string)dr["celphone"], (string)dr["addres"], (string)dr["mail"]);
